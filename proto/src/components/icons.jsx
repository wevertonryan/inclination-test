...
export function CalibrationIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="m5.6 5.6 2.1 2.1M18.4 5.6l-2.1 2.1M5.6 18.4l2.1-2.1M18.4 18.4l-2.1-2.1" />
    </svg>
  )
}
...
export function ReportsIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M9 3v6H3M21 3l-7.5 7.5M15 10h6" />
    </svg>
  )
}
...
export function TestsIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M3.5 6h.01M3.5 12h.01M5.5 6a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" />
    </svg>
  )
}
...
export function QuestionIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9.5 8.8a2.6 2.6 0 1 1 3.6 3.5c-.9.7-1.1 1.2-1.1 2.2" />
      <circle cx="12" cy="18.4" r="0.4" fill="currentColor" />
    </svg>
  )
}
...
export function SensorIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M8.4 8.4a5.4 5.4 0 0 0 0 7.2M15.6 8.4a5.4 5.4 0 0 1 0 7.2" />
      <path d="M5.5 5.5a9.5 9.5 0 0 0 0 13M18.5 5.5a9.5 9.5 0 0 1 0 13" />
    </svg>
  )
}

export function ChartXYZIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M2 8.5c2.2 0 2.2-2.2 4.4-2.2s2.2 2.2 4.4 2.2 2.2-2.2 4.4-2.2 2.2 2.2 4.4 2.2" />
      <path d="M2 13.5c2.2 0 2.2-2.2 4.4-2.2s2.2 2.2 4.4 2.2 2.2-2.2 4.4-2.2 2.2 2.2 4.4 2.2" opacity=".55" />
      <path d="M2 18.5c2.2 0 2.2-2.2 4.4-2.2s2.2 2.2 4.4 2.2 2.2-2.2 4.4-2.2 2.2 2.2 4.4 2.2" opacity=".25" />
    </svg>
  )
}

export function ChartAbsIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M2 12c2.2 0 2.2-4.4 4.4-4.4s2.2 4.4 4.4 4.4 2.2-4.4 4.4-4.4 2.2 4.4 4.4 4.4 2.2-4.4 4.4-4.4" />
    </svg>
  )
}
